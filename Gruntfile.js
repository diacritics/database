 ...
 * Released under the MIT license https://git.io/viKGx
 *****************************************************/
"use strict";
module.exports = grunt => {
     ...
     * - output: combined string (default); set to "array" for an array of
     *           values
     */
    ...
    function preserveUnicode(obj, output) {
        // code from http://tinyurl.com/jtpt7dh
    ...
    /**
     * Build equivalents data using some external data
     * ("resources/html-entities.js"), unicode conversion and normalization
     * functions
     */
    function makeEquivalents(settings) {
        ...
        for(indx = 0; indx < len; indx++) {
            ...
            if(!/^[\u0000-\u007f]$/.test(char)) {
                ...
                // normalization time! See http://tinyurl.com/82n3hkr
    ...
    function buildDist(equivalents, output) {
        ...
        for(indx = 0; indx < len; indx++) {
            ...
            if(langData) {
                ...
                grunt.file.write(
                    "dist/" + files[indx],
                    preserveUnicode(langData, output)
                );
            } else {
    ...
    grunt.registerTask("makeLangFiles", () => {
        ...
        // grunt.file.write(
        //     "build/equivalents.json",
        //     JSON.stringify(equivalents, null, 4)
        // );
